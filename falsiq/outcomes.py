...
from .facts import AttackFact, Fact, IntentFact, OutcomeFact, RulingFact


def build_outcomes_report(facts: Sequence[Fact]) -> dict[str, object]:
    ...
    for case_id in case_ids:
        ...
        outcomes = [
            fact.otype
            for fact in facts
            if isinstance(fact, OutcomeFact) and fact.case_id == case_id
        ]
        cases[case_id] = {
            "rounds_used": sorted({attack.round for attack in case_attacks}),
