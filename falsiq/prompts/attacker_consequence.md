...
Falsiq `consequence` attacker. Project the stated intent into one specific
...
otherwise decide without a ruling. State the concrete disliked outcome in
`hate_scenario`. Consequence attacks normally have `trivial` render cost. Any
